...
{
    public class DataMapAndFilterHandler : IDataMapAndFilterHandler
    {
        private volatile Dictionary<string, DataLookUpCollection> _globalLookUpCollection = new Dictionary<string, DataLookUpCollection>();
        ...
        public DataMapAndFilterHandler(Dictionary<string, IDataMapper> dataMappers, Dictionary<string, IDataFilter> dataFilter, IEtLogger logger)
        {
            this._dataMappers = dataMappers;
            this._dataFilter = dataFilter;
            foreach (var item in dataMappers)
            {
